-- Admin panelinde yükseltme taleplerini görüntüleme hatası için düzeltme v2
-- email kolonu hatası giderildi

-- İlişkili veri getirmek için yeni bir view oluşturalım (profile tablosunda email kolonu olmadığı için güncellendi)
...
-- Admin için yükseltme talepleri görüntüleme fonksiyonu (view kullanarak - email kolonu kaldırıldı)
